...
export const Layout = () => {
  ...
  const particles = useMemo(() =>
    [
      { left: 15, top: 10 }, { left: 35, top: 55 }, { left: 60, top: 20 },
      { left: 75, top: 70 }, { left: 50, top: 85 }, { left: 90, top: 40 },
    ].map((pos, i) => ({
      key: i,
      style: {
        left: `${pos.left}%`,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 transition-all duration-700">
      ...
      <div className={`${isMobile ? '' : 'ml-64'} pt-16 ${isMobile ? 'pb-36' : 'pb-24'} min-h-screen relative z-10`}>
      ...
      {/* Floating particles — positions are stable (seeded per index) */}
